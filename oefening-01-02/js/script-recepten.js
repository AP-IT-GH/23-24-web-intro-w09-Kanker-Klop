...
fetch('https://api.sampleapis.com/coffee/hot/?results=20')
  ...
  .then(json => {
    ...
    let html = '<div class="accordion accordion-flush" id="recepten">';
    ...
    for (let i = 0; i < json.length - 2; i++) {
      ...
      html += `<div class="accordion-item">
            ...
            <h2 class="accordion-header">
              ...
              <div id="collapse${i}" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#recepten">
              <div class="accordion-body">
              <img src="https://api.sampleapis.com/coffee/hot/i" class="float-start" alt="        "><span class="h6 mt-2">ingrediënten</span>:            <hr><span class="h6  mt-2">bereiding</span>:         </div>
            </div>
      </div>`;
    }
    html += '</div>';
